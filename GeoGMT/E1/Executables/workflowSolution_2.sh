...
gmt psbasemap -R -J -N1p/thinner -Df -O -K >> $node876448742
node876447781=$node876448742
gmt pscoast -R -J -Icornflowerblue -Df -K -P -O >> $node876447781
...
gmt pscoast -R -J -N1p/thinner -Df -K -O >> $node876442976
