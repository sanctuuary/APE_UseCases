...
gmt psxy -R -J -O -V -Wthinnest $node2077172800 >> $node876448742
node876447781=$node876448742
"Error. Tool 'pscoast_U' is missing the execution code."
gmt psxy -R -J -O -Sc0.05 -Gred -Wthinnest $node2077172800 >> $node876446820
...
gmt pscoast -R -J -N1p/thinner -Df -K -O >> $node876443937
node876442976=$node876443937
gmt pscoast -R -J -N1p/thinner -Df -O -K >> $node876442976
