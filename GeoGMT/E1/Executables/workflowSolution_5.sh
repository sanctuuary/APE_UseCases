...
gmt pscoast -R -J -Scornflowerblue -Df -K -P -O >> $node876448742
node876447781=$node876448742
"Error. Tool 'psbasemap_U' is missing the execution code."
gmt psbasemap -R -J -N1p/thinner -Df -O -K >> $node876446820
node876445859=$node876446820
"Error. Tool 'pscoast_Bt' is missing the execution code."
gmt pscoast -R -J -N1p/thinner -Df -K -O >> $node876444898
node876443937=$node876444898
gmt psxy -R -J -O -V -Wthinnest $node2077172800 >> $node876443937
node876442976=$node876443937
gmt psxy -R -J -O -Sc0.05 -Gred -Wthinnest $node2077172800 >> $node876442976
